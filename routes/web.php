...
// landing page
Route::get('/', function () {
    return view('index', ['judul_halaman' => 'Desa Wisata Golo Loni']);
});
Route::get('/about', function () {
    return view('about', ['judul_halaman' => 'Tentang Kami | Desa Wisata Golo Loni']);
});
Route::get('/gallery', function () {
    return view('gallery', ['judul_halaman' => 'Galeri | Desa Wisata Golo Loni']);
});
Route::get('/blog', function () {
    return view('blog', ['judul_halaman' => 'Blog | Desa Wisata Golo Loni']);
});
Route::get('/blog/slug', function () {
    return view('blog-details', ['judul_halaman' => 'Judul Postingan | Desa Wisata Golo Loni']);
});
Route::get('/contact', function () {
    return view('contact', ['judul_halaman' => 'Kontak Kami | Desa Wisata Golo Loni']);
});
