                        ...
                        <div class="inner-container">
                            ...
                            <div class="logo-box">
                                <div class="logo">
                                    ...
                                    <a href="/"><h1 class="text-white">Golo Loni</h1><p class="text-white">Desa Wisata</p></a>
                                </div>
                            </div>
                            <!--Nav Box-->
                            <div class="nav-outer">
                                ...
                                <nav class="main-menu navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation">
                                            ...
                                            <li class="{{ ($judul_halaman === 'Tentang Kami | Desa Wisata Golo Loni')?'current':'' }}"><a href="/about">Tentang Kami</a></li>
                                            <li class="{{ ($judul_halaman === 'Galeri | Desa Wisata Golo Loni')?'current':'' }}"><a href="/gallery">Galeri</a></li>
                                            <li class="{{ ($judul_halaman === 'Blog | Desa Wisata Golo Loni')?'current':'' }}"><a href="/blog">Blog</a></li>
                                            <li class="{{ ($judul_halaman === 'Kontak Kami | Desa Wisata Golo Loni')?'current':'' }}"><a href="/contact">Kontak</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo">
                            ...
                            <a href="/">Desa Wisata Golo Loni</a>
                        </div>
                                    ...
                                    <div class="widget-content">
                                        <ul class="contact-info">
                                            <li>
                                                ...
                                                <div class="text">
                                                    <strong>Lokasi</strong> Desa Golo Loni, Kecamatan Rana Mese<br />
