...
<html class="no-js" lang="en">
    <head>
        <?php 
        $keywords = "desa, wisata, golo loni, desa wisata, desa golo loni, wisata golo loni, desa wisata golo loni, ntt, nusa tenggara timur, manggarai barat";
            ...
            <nav class="navbar navbar-default bootsnav background-black header-dark white-link navbar-top navbar-expand-lg on no-full">
                <div class="container-lg nav-header-container">
                    ...
                    <div class="col-auto ps-0">
                        <a href="/" title="Desa Wisata golo loni" class="logo">
        ...
        <footer class="footer-standard-dark bg-extra-dark-gray"> 
            ...
            <div class="container margin-20px-top">
                <div class="border-color-medium-dark-gray border-top padding-40px-top">
                    <div class="row"> 
                        <!-- start copyright -->
                        <div class="text-center">© {{ date('Y') }} Golo Loni - Powered by <a href="https://jongkreatif.id" target="_blank" class="text-dark-gray">JongKreatif</a>.</div>
                        <!-- end copyright -->
                    </div>
                </div>
            </div>
